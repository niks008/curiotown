      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
                <td><span>*</span> <?php echo $entry_description; ?></td>
                <td><textarea name="manufacturer_description" id="description1"><?php echo isset($manufacturer_description['description']) ? $manufacturer_description['description'] : ''; ?></textarea>
                  <?php if (isset($error_description)) { ?>
                  <span><?php echo $error_description; ?></span>
                  <?php } ?></td>
             </tr>
            <tr>
