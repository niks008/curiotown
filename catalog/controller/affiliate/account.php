...
//        $this->data['edit'] = $this->url->link('affiliate/edit/firstname', '', 'SSL');
//        $this->data['entry_firstname'] = $this->language->get('affiliate/edit/firstname', '', 'SSL');
//        $this->data['firstname'] = $this->url->link('entry_firstname');
