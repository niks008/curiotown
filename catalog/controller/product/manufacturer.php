		...
		foreach ($results as $result) {
			...
			$this->data['categories'][$key]['manufacturer'][] = array(
				...
				'href' => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $result['manufacturer_id']),
                           ...
                           'description' => $this->data['manufacturer_description'] = html_entity_decode($result['description']),
...
//                        $this->data['manufacturer_image'] = $this->model_tool_image->resize($manufacturer_info['image'], $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height'));
//                                 
		} else {
	...
	public function info() {
		...
		if ($manufacturer_info) {
			$this->document->setTitle($manufacturer_info['name']);
                        ...
                        $this->data['manufacturer_description'] = html_entity_decode($manufacturer_info['description']);
