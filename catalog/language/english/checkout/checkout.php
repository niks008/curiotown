...
$_['error_telephone']                = 'Telephone must be between 3 and 10 numeric values!';
$_['error_telephone-no']             = 'Telephone must contain only numeric values!';
$_['error_fax']                      = 'Fax must be between 3 and 10 numerics!';
$_['error_fax-no']                   = 'Fax must contain only numeric values!';
...
$_['error_postcode-no']              = 'Postcode must contain only numeric values!';
