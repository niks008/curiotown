...
//					$('#notification').html('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div>');
					$.colorbox({html:'<div class="warning">' + json['error']['warning'] + '<img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div>', opacity:0.3, width:700, height:120});
					$('.warning').fadeIn('slow');
...
$('document').ready(function(){
    ...
    if(value != ""){
                                    ...
                                    var data ={
                                        ...
                                        $.ajax({
                                                type: 'POST',
                                                url: 'index.php?route=checkout/cart/stockcheck',
                                                dataType: "html",
                                                data : data,
